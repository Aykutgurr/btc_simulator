...
class MainWindow(QMainWindow):
    def __init__(
        ...
        self.label_total_return = QLabel("Toplam Getiri: -")
        self.label_sharpe = QLabel("Sharpe (yaklaşık): -")
        ...
        stats_grid.addWidget(self.label_total_return, 2, 1)
        stats_grid.addWidget(self.label_sharpe, 3, 0)
    ...
    def _update_stats(self) -> None:
        ...
        self.label_total_return.setText(f"Toplam Getiri: {s.get('total_return_pct', 0.0):.2f}%")
        self.label_sharpe.setText(f"Sharpe (yaklaşık): {s.get('sharpe_ratio', 0.0):.3f}")
